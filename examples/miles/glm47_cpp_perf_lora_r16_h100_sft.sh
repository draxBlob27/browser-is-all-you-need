...
# The longest-128 Lium probe peaks at 72.4 GiB with real dynamic packing at
# 16384 tokens/GPU. This leaves usable H100 headroom without paying for tiny
# one-sequence microbatches.

...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    backfill.add_argument("--timing-status", default=os.environ.get("W8_TIMING_STATUS", "unverified"))
    ...
    compare.add_argument("--timing-status", default=os.environ.get("W8_TIMING_STATUS", "unverified"))
...
def _add_wandb_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--experiment-id", default=os.environ.get("W8_EXPERIMENT_ID", ""))

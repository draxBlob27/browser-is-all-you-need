...
lightweight_train_only_clear=${W8_GLM47_LIGHTWEIGHT_TRAIN_ONLY_CLEAR:-0}
EOF
  cat "${RUN_RECEIPT}"
}
...
env = {
    ...
    "W8_CPP_SANDBOX_BACKEND": os.environ.get("W8_CPP_SANDBOX_BACKEND", "docker"),
...
for key in (
    ...
    "W8_GLM47_LIGHTWEIGHT_TRAIN_ONLY_CLEAR",
):

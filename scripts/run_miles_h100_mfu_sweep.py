...
TRIAL_SPECS = (
    ...
    TrialSpec(
        ...
        "Overlap distributed-optimizer parameter gathering with forward compute.",
        {},
    ...
    TrialSpec(
        7,
        "ddp_overlap",
        "Combine the two orthogonal distributed-optimizer overlap paths.",
        {},
    ...
    TrialSpec(
        8,
        "moe_ep_overlap",
        "Overlap expert-parallel communication with MoE compute.",
        {},
